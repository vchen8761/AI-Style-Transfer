...
class DeepLabModel(object):
  ...
  def __init__(self, tarball_path):
    ...
    graph_def = None
    graph_def = tf.GraphDef.FromString(open("./image-background-removal/mobile_net_model/frozen_inference_graph.pb", "rb").read()) 
...
def drawSegment(baseImg, matImg):
  ...
  # Take segmented image and paste on colored background
  # May parameterize this so that we can match color background
  # img.load()
